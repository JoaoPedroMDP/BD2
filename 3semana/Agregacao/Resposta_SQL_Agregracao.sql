...
CREATE TABLE trabalha(
	...
	CONSTRAINT pk_trabalha PRIMARY KEY (cod_empresa, cod_egresso, cod_habil, cod_egresso),
	CONSTRAINT fk_empresa FOREIGN KEY (cod_empresa) REFERENCES empresa (cod),
	CONSTRAINT fk_cursou FOREIGN KEY (cod_egresso, cod_habil, cod_egresso) REFERENCES egresso(cod_egresso, cod_habil, cod_egresso)
);
...
CREATE TABLE treina(
	...
	CONSTRAINT fk_trabalha
		FOREIGN KEY (cod_empresa, cod_egresso, cod_habil, cod_egresso) 
		REFERENCES trabalha (cod_empresa, cod_egresso, cod_habil, cod_egresso),
